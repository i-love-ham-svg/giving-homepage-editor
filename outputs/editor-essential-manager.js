  ...
  function createFooterDocuments() {
    return {
      privacy: {
        ...
        content: [
          "송악사회복지관은 개인정보 보호법에 따라 정보주체의 개인정보를 보호하고 관련 고충을 처리하기 위하여 다음과 같이 개인정보처리방침을 공개합니다.",
  ...
  function createTemplateModel(template) {
    if (template === "organization") {
      return {
        ...
        description: "공식 홈페이지에 공개된 4개 실무팀의 직책과 담당업무를 기준으로 구성했습니다.",
        details: [
        ...
        items: [
          ...
          { id: "organization-official-case-lead", badge: "사례관리팀", title: "팀장", meta: "육아휴직", description: "공식 조직도에 공개된 현재 상태입니다." },
        ...
        note: "직원 이름은 공식 사이트에서 보호 처리되어 공개 확인 가능한 관장 실명만 반영했습니다. 대표전화 041-353-5077로 담당 팀을 확인할 수 있습니다."
      };
    }
    ...
    if (template === "notice") {
      ...
      return {
        ...
        ctaLabel: "공지사항 전체보기",
        note: "2026년 7월 27일 기준 송악사회복지관 공식 공지사항 상위 10개 게시물입니다."
      };
    }
    ...
    if (template === "schedule") {
      return {
        ...
        headline: "3월 기준 프로그램 시간표",
        description: "송악사회복지관 공식 시간표 원본을 읽기 쉬운 프로그램 카드로 정리했습니다.",
        details: [
        ...
        note: "공식 홈페이지의 3월 기준 원본 시간표를 반영했습니다. 일정 변경과 모집 여부는 최신 공지사항을 우선 확인해 주세요."
      };
    }
