(function () {
  ...
  const BUNDLES = {
    ...
    schedule: {
      ...
      models: {
        hero: { template: "schedule", label: "프로그램 시간표 · 메인 소개", eyebrow: "PROGRAM SCHEDULE", headline: "프로그램 일정 안내", description: "프로그램 일정은 운영 상황에 따라 달라질 수 있으니 공지사항 또는 대표전화로 최신 내용을 확인해 주세요.", ctaLabel: "시간표 확인", detailSecondaryCta: "프로그램 신청" },
        facts: { template: "schedule", label: "프로그램 시간표 · 운영 기준", headline: "운영 기준", description: "모집 상황과 휴강 일정은 공지사항을 우선 확인해 주세요.", details: [
          { id: "schedule-fact-period", label: "안내", value: "일정 변경 가능 · 최신 공지 확인" }, { id: "schedule-fact-open", label: "자율이용", value: "월·목 오전 / 시설 정비 별도" }, { id: "schedule-fact-contact", label: "문의", value: "041-353-5077" }
        ] },
        ...
        source: { template: "schedule", label: "프로그램 시간표 · 인쇄용", headline: "인쇄용 프로그램 시간표", description: "게시 시점의 시간표이며 현재 운영 일정과 다를 수 있습니다. 최신 공지 또는 대표전화 041-353-5077로 확인해 주세요.", detailAssetUrl: "assets/official-sacwc/program-schedule-original.jpg", detailAssetAlt: "송악사회복지관 프로그램 시간표", ctaLabel: "시간표 크게 보기" }
      }
    },
    case: {
    ...
    organization: {
      ...
      models: {
        ...
        structure: { template: "organization", label: "조직도·직원 · 운영 체계", eyebrow: "관장", headline: "운영 체계", description: "복지관의 운영 체계와 부서별 담당 업무를 안내합니다.", ctaLabel: "김형철 관장", note: "복지관 운영 총괄", details: [
        ...
        staff: { template: "organization", label: "조직도·직원 · 부서별 안내", headline: "직원·담당 업무", description: "개인정보 보호를 위해 공식 페이지에서 확인 가능한 실명만 표시하며, 그 외에는 직책과 업무로 안내합니다.", items: list("org-staff", [
          ...
          ["사례관리팀","팀장","팀 총괄","사례관리팀의 업무와 지역 자원 연계를 총괄합니다."], ["사례관리팀","사회복지사","사례관리·지역사회보호","복합적인 어려움이 있는 주민의 상담과 자원 연계를 담당합니다."], ["사례관리팀","사회복지사","사례관리사업","지역주민 사례관리 업무를 담당합니다."],
    ...
    video: {
      ...
      models: {
        hero: { template: "facility", label: "영상 아카이브 · 메인 소개", eyebrow: "SONGAK VIDEO", headline: "영상으로 만나는 송악의 사람과 이야기", description: "복지관의 주요 활동 영상을 한곳에서 확인할 수 있습니다.", ctaLabel: "영상 둘러보기", detailSecondaryCta: "YouTube 검색" },
        archive: { template: "facility", label: "영상 아카이브 · 복지관 영상", headline: "영상 아카이브", description: "제목이나 활동명을 검색해 보세요.", items: list("video", [
          ["복지관 영상 · YouTube","25년 송악실버학당 4기 활동영상","nUWMRojXmVI","송악실버학당 4기의 활동 기록입니다."], ["복지관 영상 · YouTube","[2025년] 함께 만든 변화, 함께 나눈 하루들의 기록","kyQhkc6hG9M","2025년 주민과 함께 만든 복지관 활동을 영상으로 소개합니다."], ["복지관 영상 · YouTube","2025년 송악사회복지관 사회복지현장실습 이야기","1vok5vBLvEE","사회복지현장실습 과정과 참여 이야기를 담았습니다."], ["복지관 영상 · YouTube","[2025년 상반기] 함께여서 더 빛났던, 송악사회복지관 이야기","xS3G8glmf5U","2025년 상반기 복지관 활동을 돌아보는 영상입니다."], ["복지관 영상 · YouTube","25년 송악사회복지관의 어버이날 이야기","beD90-10L80","지역 어르신과 함께한 어버이날 활동 기록입니다."], ["복지관 영상 · YouTube","송악사회복지관 프로그램 소개","_dyB7jHw7XU","복지관에서 운영하는 주요 프로그램을 영상으로 안내합니다."]
        ...
        guide: { template: "facility", label: "영상 아카이브 · 이용 안내", eyebrow: "YouTube에서 시청하세요", headline: "영상 이용 안내", description: "영상을 선택하면 YouTube에서 재생됩니다.", note: "외부 영상 재생 시 YouTube의 이용정책이 적용됩니다.", ctaLabel: "" }
      }
    },
    application: {
      label: "온라인 신청", originalIds: [], kinds: ["hero", "form"],
      models: {
        hero: { template: "volunteer", label: "온라인 신청 · 메인 소개", eyebrow: "ONLINE APPLICATION", headline: "온라인 신청서 작성 안내", description: "온라인 신청 기능은 시범 운영 중입니다. 작성 후 전송 결과를 확인하고, 접수 여부는 대표전화 041-353-5077로 최종 확인해 주세요.", ctaLabel: "신청 내용 작성", detailSecondaryCta: "전화 문의" },
        form: { template: "volunteer", label: "온라인 신청 · 신청서", headline: "온라인 신청", description: "필수 항목만 입력하며, 전송되지 않은 경우에는 대표전화로 문의해 주세요.", items: list("application-field", [
    ...
    account: {
      ...
      models: {
        ...
        guide: { template: "volunteer", label: "SNS 회원 · 이용 안내", eyebrow: "시범 운영 안내", headline: "담당자 로그인 이용 안내", description: "현재 SNS 버튼은 시범 운영용 담당자 로그인 화면으로 연결됩니다.", note: "실제 SNS 계정 연동은 아직 사용하지 않으며, 임시 로그인 정보는 복지관 담당자에게만 전달합니다.", ctaLabel: "개인정보처리방침", detailSecondaryCta: "대표전화 041-353-5077" }
      }
    }
  };
